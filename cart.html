        ...
        <header>
            ...
            <div id="banner" class="container">
                <div class="row">
                    ...
                    <div class="header-menu col-xs-12 col-sm-7 col-md-5">
                ...
                <div class="col-12">
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <td><img src="./images/placeHolder.jpg" /> </td>
                                    <td>Product Name</td>
                                    <td>In stock</td>
                                    <td><input class="form-control" type="text" value="1" /></td>
                                    <td class="text-right">124.000đ</td>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td>Sub-Total</td>
                                    <td class="text-right">372.000đ</td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right"><strong>397.000đ</strong></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
